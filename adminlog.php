...
if(isset($_POST['signin']))
{
	...
	$sql ="SELECT * FROM register where email ='$email' AND password ='$password' AND user_type='1'";
...
<body>
      ...
      <section class="panel panel-default bg-white m-t-lg">
        ...
        <form name="signin" method="post">
          <div class="panel-body wrapper-lg">
            ...
            <input name="email" type="email" placeholder="xyz@example.com" class="form-control input-lg">
          </div>
          <div class="form-group">
  ...
  <footer id="footer">
    <div class="text-center padder">
      <p>
        <small>Notebook | Web Application by Saroj<br>&copy; 2024</small>
      </p>
    </div>
  </footer>
  <!-- / footer -->

...
<body>
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xxl">
      <a class="navbar-brand block" href="login.php">NoteFlow</a>
      <section class="panel panel-default bg-white m-t-lg">
        ...
        <form name="signin" method="post">
          <div class="panel-body wrapper-lg">
            ...
            <input name="email" type="email" placeholder="shaharyan408@example.com" class="form-control input-lg">
          </div>
          <div class="form-group">
  ...
  <footer id="footer">
    <div class="text-center padder">
      <p>
        <small>NoteFlow | Web Application by Aaryanshah<br>&copy; 2023</small>
      </p>
    </div>
  </footer>
  <!-- / footer -->
